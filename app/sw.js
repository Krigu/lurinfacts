...
var urlsToCache = [
  ...
  "/styles/main.css?q=#CACHE_VERSION_PLACEHOLDER#",
  "/images/header.png",
  "images/twitter_logo.png",
  "/scripts/scripts.js?q=#CACHE_VERSION_PLACEHOLDER#",
  "/scripts/vendor.js?q=#CACHE_VERSION_PLACEHOLDER#",
...
(global => {
  ...
  self.addEventListener("notificationclick", function(event) {
    ...
    const lurinfactsLink =
      self.location.origin + "/" + (clickedNotification.data && clickedNotification.data.url) ||
      "/";
